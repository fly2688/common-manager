...
var maps = [
  ...
  },
  {
    ...
    {
      name: '洛阳市',
      areaList: ['老城区', '西工区', '瀍河回族区', '涧西区', '吉利区', '洛龙区', '孟津县', '新安县', '栾川县', '嵩　县', '汝阳县', '宜阳县', '洛宁县', '伊川县', '偃师市']},
    {
      name: '平顶山市',
    ...
    {
      name: '焦作市',
      areaList: ['解放区', '中站区', '马村区', '山阳区', '修武县', '博爱县', '武陟县', '温　县', '沁阳市', '孟州市']},
    {
      name: '濮阳市',
  ...
  },
  {
    ...
    cityList: [{
      name: '哈尔滨市',
      areaList: ['道里区', '南岗区', '道外区', '香坊区', '平房区', '松北区', '呼兰区', '依兰县', '方正县', '宾　县', '巴彦县', '木兰县', '通河县', '延寿县', '阿城市', '双城市', '尚志市', '五常市']},
    {
      name: '齐齐哈尔市',
    ...
    {
      name: '佳木斯市',
      areaList: ['向阳区', '前进区', '东风区', '郊　区', '桦南县', '桦川县', '汤原县', '抚远县', '同江市', '富锦市']},
    {
      name: '七台河市',
    ...
    {
      name: '大兴安岭地区',
      areaList: ['呼玛县', '塔河县', '漠河县', '加格达奇区', '松岭区', '新林区', '呼中区']}]
  },
  {
    name: '海南',
    cityList: [{
  ...
  },
  {
    ...
    cityList: [{
      name: '澳门',
      areaList: ['花地玛堂区', '圣安多尼堂区', '大堂区', '望德堂区', '风顺堂区', '嘉模堂区', '圣方济各堂区', '路凼']}]
  },
  {
    name: '香港',
    cityList: [{
      name: '香港',
      areaList: ['深水埗区', '油尖旺区', '九龙城区', '黄大仙区', '观塘区', '北区', '大埔区', '沙田区', '西贡区', '元朗区', '屯门区', '荃湾区', '葵青区', '离岛区', '中西区', '湾仔区', '东区', '南区']}]
  }
]
export default{
  maps
